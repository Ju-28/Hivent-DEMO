...
export default function AllEvents() {
  ...
  return (
    <div className="hub-all">
      <Header />
      <div className="hub-all-main">
        <div className="hub-all-hero">
          <h1 className="hub-all-title">Alle Events</h1>
          <section className="hub-all-intro">
            Hier findest du alles was dein Herz begehrt. Mache dir
            <span className="brandname"> HIVENT</span> zu Nutze und finde unter
            unseren Partnern genau das richtige Event für dich.
          </section>
        </div>
        <div className="event-search-bar">
          ...
          <div className="event-search-bar-filter-wrapper">
            <div
              className={isActive ? "active" : "event-search-bar-filter-button"}
                  ...
                  <div className="attendees-filter-wrapper">
                    ...
                    <div className="filter-options">
                      {averageAttendees.map((attendee) => (
                        <label key={attendee.name} className="checkbox-label">
                          <input
                            type="radio"
                            name="attendees"
                            value={attendee.name}
